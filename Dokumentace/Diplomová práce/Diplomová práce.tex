...
Jak již bylo řečeno, domovní systém je kombinací zabezpečovacího zařízení a spínacích prvků. Těmto částem se budu věnovat níže, kde vyberu nejvhodnější varianty.
...
Operační systém byl zvolen Windows 10, kvůli rychlosti vývoje. Programovací jazyk C\# a vývojové prostředí Visual Studio 2017. Komunikace s aplikací bude probíhat skrze pevné připojení k internetu.
